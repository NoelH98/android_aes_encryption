# Android AES Encryption App

Android app that encrypts and decrypt text using aes encryption.
...
```bash
git clone https://github.com/NoelH98/android_aes_encryption.git
```
